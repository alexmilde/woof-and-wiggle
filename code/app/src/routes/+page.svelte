        ...
        <div class="col-span-10 col-start-2 xl:col-span-8 xl:col-start-3 mt-2 mb-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 mt-8">
                {#each searchResults as searchResult}
                    <div
                        class="relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 pt-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400"
                    >
